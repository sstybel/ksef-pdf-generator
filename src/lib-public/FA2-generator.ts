...
export function generateFA2(invoice: Faktura, additionalData: AdditionalDataTypes, dataUri?: string, filename?: string, dateInv?: Date, dateInvStor?: Date, description?: string, relationship?: string, language?: string): TCreatedPdf {
